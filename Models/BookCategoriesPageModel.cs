...
namespace Niga_Ionut_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Niga_Ionut_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Niga_Ionut_Lab8Context context,
